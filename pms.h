...
void USWB::update_goodvarstack1(int flipvar)
{
	int v;
...
void USWB::update_goodvarstack2(int flipvar)
{
...
inline void USWB::unsat(int clause)
{
...
inline void USWB::sat(int clause)
{
